...
\hypersetup{
    ...
    filecolor=magenta,
    urlcolor=cyan,
    pdftitle={Отчет по методу Симпсона},
    pdfauthor={Филатьева Елизавета},
    pdfsubject={Параллельное программирование},
    pdfkeywords={Симпсон, параллельное программирование, OpenMP, TBB, STL, MPI}
}
